...
public class PermissionController extends BaseController
{
    ...
    public @ResponseBody
    List<Permission> tree(@ApiParam(value = "应用id") Integer appId, @ApiParam(value = "角色id") Integer roleId, @ApiParam(value = "是否启用 ") Boolean isEnable)
    {
    ...
    public @ResponseBody
    Result delete(@ApiParam(value = "id", required = true) @ValidateParam({Validator.NOT_BLANK}) Integer id,
                  @ApiParam(value = "应用id", required = true) @ValidateParam({Validator.NOT_BLANK}) Integer appId)
    {
