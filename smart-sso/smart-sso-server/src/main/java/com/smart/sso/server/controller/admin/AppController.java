...
public class AppController extends BaseController
{
    ...
    public @ResponseBody
    Result list(@ApiParam(value = "名称 ") String name,
    ...
    public @ResponseBody
    Result validateCode(@ApiParam(value = "id") Integer id, @ApiParam(value = "应用编码", required = true) @ValidateParam({Validator.NOT_BLANK}) String code)
    {
