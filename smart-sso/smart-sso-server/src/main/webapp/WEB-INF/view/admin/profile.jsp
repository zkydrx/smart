                            ...
                            <div class="tab-content profile-edit-tab-content">
                                <div id="edit-basic" class="tab-pane in active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label class="control-label"><b><fmt:formatDate value="${user.createTime}"
                                                                                            pattern="yyyy-MM-dd HH:mm:ss"/></b></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right"
                                               for="form-field-facebook">最后登录IP</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label class="control-label"><b><fmt:formatDate
                                ...
                                <div id="edit-password" class="tab-pane">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="help-validate">
                                                <input id="_newPassword" name="newPassword" type="password" value=""
                                                       class="form-data"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="help-validate">
                                                <input id="_confirmPassword" name="confirmPassword" type="password"
                                                       value="" class="form-data"
