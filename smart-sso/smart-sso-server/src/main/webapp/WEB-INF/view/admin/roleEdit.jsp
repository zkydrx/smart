    ...
    <div class="col-xs-12">
        ...
        <form id="_editForm" class="form-horizontal" role="form"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="clearfix help-validate">
                        <input id="_name" name="name" type="text" value="${role.name}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="clearfix help-validate">
                        <input id="_sort" name="sort" type="text" value="${role.sort}"
                ...
                <div class="col-sm-9">
                    <div class="clearfix help-validate">
                        <div class="input-group">
							<textarea id="_description" name="description" class="autosize-transition form-control"
                                      placeholder="描述"
                        ...
                        <div>
                            <label class="line-height-1 blue">
                                <input name="isEnable" value="true" type="radio"
                                       class="ace" ${role.isEnable ? 'checked="checked"' : ''}/>
