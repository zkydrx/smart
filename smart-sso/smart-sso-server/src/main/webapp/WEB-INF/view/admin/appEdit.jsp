...
<div class="row">
    <div class="col-xs-12">
        <form id="_editForm" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="clearfix help-validate">
                        <input id="_name" name="name" type="text" value="${app.name}"
                               class="form-data col-xs-10 col-sm-5" placeholder="应用名称"
            ...
            <div class="form-group">
                <label for="_code" class="col-sm-3 control-label no-padding-right"><span
                        class="form-star">*</span>编码</label>

                <div class="col-sm-9">
                    <div class="clearfix help-validate">
                        <input id="_code" name="code" type="text" value="${app.code}"
                               class="form-data col-xs-10 col-sm-5" placeholder="应用编码"
                               required="true"
                               ajax="{url : '${_path}/admin/app/validateCode', type : 'post', dataId : '_editForm'}"
                               maxlength="64"/>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="clearfix help-validate">
                        <input id="_sort" name="sort" type="text" value="${app.sort}"
                               class="form-data col-xs-10 col-sm-5" placeholder="排序"
                    ...
                    <div class="clearfix help-validate">
                        <div>
                            <label class="line-height-1 blue">
                                <input name="isEnable" value="true" type="radio"
                                       class="ace" ${app.isEnable ? 'checked="checked"' : ''}/>
                        ...
                        <div>
                            <label class="line-height-1 blue">
                                <input name="isEnable" value="false" type="radio"
                                       class="ace" ${!app.isEnable ? 'checked="checked"' : ''}/>
