...
<div class="row">
    ...
    <a id="my-modal-a" href="#my-modal" role="button" class="bigger-125 bg-primary white" style="display: none;"
       data-toggle="modal"></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="_editForm" class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix help-validate">
                                    <input id="_name" name="name" type="text" class="form-data col-xs-10 col-sm-5"
                                           placeholder="名称"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix help-validate">
                                    <input id="_icon" name="icon" type="text" class="form-data col-xs-10 col-sm-5"
                                           placeholder="图标"
                                           maxlength="100"/>&nbsp;
                                    <i id="_icon_fa"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix help-validate">
                                    <input id="_sort" name="sort" type="text" class="form-data col-xs-10 col-sm-5"
                                           placeholder="排序"
                        ...
                        <div class="form-group">
                            <label for="_url" class="col-sm-3 control-label no-padding-right"><span
                                    class="form-star">*</span>URL</label>

                            <div class="col-sm-9">
                                <div class="clearfix help-validate">
                                    <input id="_url" name="url" type="text" class="form-data col-xs-10 col-sm-9"
                                           placeholder="URL"
                                           required="true" maxlength="64"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="_isMenu" class="col-sm-3 control-label no-padding-right"><span
                                    class="form-star">*</span>是否菜单</label>
                        ...
                        <div class="form-group">
                            <label for="_isEnable" class="col-sm-3 control-label no-padding-right"><span
                ...
                <div class="modal-footer">
                    ...
                    <button id="_submit" class="btn btn-sm btn-success pull-right" data-dismiss="modal"
                ...
                if (deleteBtn) {
                    deleteBtn.bind("click", function () {
                        bootbox.confirm("会删除该权限所有子权限，确认要删除吗?", function (result) {
                            if (result) {
                                $.post("${_path}/admin/permission/delete", {
                                    "id": treeNode.id,
                                    "appId": $("#_searchAppId option:selected").val()
                                }, function (d) {
                                    if (d) {
                                        if (d.code == 1) {
                                            $.gritter.add({
