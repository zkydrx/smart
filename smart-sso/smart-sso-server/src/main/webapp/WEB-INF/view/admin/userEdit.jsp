...
<div class="row">
    <div class="col-xs-12">
        ...
        <form id="_editForm" class="form-horizontal" role="form"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="clearfix help-validate">
                        <input id="_name" name="name" type="text" value="${user.name}"
            ...
            <div class="form-group">
                <label for="_password"
                       class="col-sm-3 control-label no-padding-right">${empty user.id ? '<span class="form-star">*</span>' : ''}密码</label>
                        ...
                        <div>
                            <label class="line-height-1 blue">
                                <input name="isEnable" value="true" type="radio"
                                       class="ace" ${user.isEnable ? 'checked="checked"' : ''}/>
