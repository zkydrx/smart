                                        ...
                                        <fieldset>
                                            <label class="block clearfix form-group">
														<span class="block input-icon input-icon-right help-validate">
															<input id="_account" name="account" value="admin"
                                                                   type="text" class="form-control form-data"
                                                                   placeholder="登录名"
                                            ...
                                            <label class="block clearfix form-group">
														<span class="block input-icon input-icon-right help-validate">
															<input id="_password" name="password" value="123456"
                                                                   type="password" class="form-control form-data"
                                                                   placeholder="密码"
                                            ...
                                            <label class="block clearfix form-group">
														<span class="block help-validate">
															<input id="_captcha" name="captcha" type="text"
                                                                   placeholder="验证码"
                                                                   required="true"/>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <button id="_loginButton" type="button"
