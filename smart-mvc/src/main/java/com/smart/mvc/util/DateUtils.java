...
public class DateUtils
{
    ...
    public static final class Age
    {
        ...
        {
            return new StringBuilder().append(year).append("岁").append(month).append("个月").append(day).append("天").toString();
        }
    }
    ...
    public static float getByCompare(String preDatetime, String afterDatetime, Integer type, Boolean hasFloat)
    {
